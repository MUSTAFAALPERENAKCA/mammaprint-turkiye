...
| P-03 | `/mammaprint/` | MammaPrint 70 Gen Testi | P0 | §8.1 | Product içerik tipi + MedicalWebPage schema | §8.1 bölümlerinin tamamı mevcut | Tamamlandı — müşteri PDF geri bildirimiyle NGS/70-465 gen açıklaması, risk skalası ve güncellenmiş FAQ eklendi |
...
| P-09 | `/hastalar-icin/kimler-icin-uygun/` | Uygunluk | P0 | §8.4, §5.1 | Kontrol listesi bileşeni | Hekim değerlendirmesi vurgusu var | Tamamlandı — müşteri PDF'inden 5 gerçek klinik uygunluk kriteri eklendi (evre, ER, HER2, tümör çapı, lenf nodu) |
...
| P-21 | `/klinik-kanit/mindact/` | MINDACT | P0 | §8.6, MVP kapsamı | ClinicalStudy detay sayfası | Kanıt kartı alanlarının tamamı dolu | Tamamlandı — MINDACT için gerçek çalışma tasarımı/hasta grubu/bulgu/kaynak (NEJM 2016, ASCO 2020) eklendi |
| P-22 | `/klinik-kanit/nbrst/` | NBRST | P0 | §8.6, MVP kapsamı | ClinicalStudy detay sayfası | Kanıt kartı alanlarının tamamı dolu | Tamamlandı — NBRST için gerçek çalışma tasarımı/bulgu/kaynak (NCT01479101) eklendi |
...
| P-26 | `/kilavuzlar/` | Kılavuzlar | P1 | §6.1 | Resource listesi | İçerik yayında | Tamamlandı — ASCO/NCCN önerisi metni + kılavuz kuruluş isimleri (metin, logo değil) eklendi |
